...
public class ForceControllerZoneContents implements Container {
     ...
     * @return the new ChestContents
     */
    public static ForceControllerZoneContents createForClientSideContainer(int size) {
        return new ForceControllerZoneContents(size);
    }
    ...
    private ForceControllerZoneContents(int size) {
